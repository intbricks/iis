...
| `reverse`         | Produce a new list from the input list in reverse order                                                                 | `reverse([1, 2, 3]) = [3, 2, 1]`                                                   |
| `setintersection` | Produce the unordered set of input sets                                                                                 | `setintersection(["a", "b"], ["b", "c"], ["b", "d"]) = ["b"]`                      |
| `setproduct`      | Produce the set product of the input sets                                                                               |                                                                                    |
| `setsubtract`     | Produce the set subtraction from the input sets                                                                         |                                                                                    |
| `setunion`        | Produce the set union from the input sets                                                                               |                                                                                    |
| `slice`           | Extract consuective elements from the list                                                                              | `slice(["a", "b", "c", "d"], 1, 3) = ["b", "c"]`                                   |
| `sort`            | Sort the input list using Unicode codepoints                                                                            | `sort(["e", "d", "a", "x"]) = ["a", "d", "e", "x"]`                                |
| `sum`             | Calculate the total of a list of numbers in the input                                                                   | `sum([10, 13, 6, 4.5]) = 33.5`                                                     |
| `values`          | Takes a map and returns a list containing the values of the elments in the map                                          | `values({a=3,c=2,d=1}) = [3, 2, 1]`                                                |
| `zipmap`          | Produce a map from inputs                                                                                               | `zipmap(["a", "b"], [1, 2]) = {"a" = 1, "b" = 2}`                                  |
